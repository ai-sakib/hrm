        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative">
                <button
                    ...
                    @click="isNotificationsMenuOpen = !isNotificationsMenuOpen"  ref="notificationsMenu"
...
<script setup>
    ...
    const { dark, toggle_dark_mode } = useDarkMode();
    const { profileMenu, isProfileMenuOpen, notificationsMenu, isNotificationsMenuOpen, isSidebarOpen, openSidebar } = useSidebarProfilemenu();
